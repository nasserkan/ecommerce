			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li>
                                <a class="slide-item" href="{{ url('/' . $page='allCategory') }}">Category</a>
                            </li>
							<li><a class="slide-item" href="{{ url('/' . $page='allProducts') }}">Products</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='featured-products') }}">Featured Products</a></li>
                            <li><a class="slide-item" href="{{ url('/' . $page='trending-products') }}">Trending Products</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='viewCart') }}">My Cart</a></li>
                            <li><a class="slide-item" href="{{ url('/' . $page='viewOrder') }}">My Orders</a></li>
						</ul>
					</li>
